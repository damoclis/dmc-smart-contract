(module
 ...
 (data (i32.const 256) "\06\00\00\00\01\00\00\00\01\00\00\00\06\00\00\00a\00a\00a\00")
 (data (i32.const 280) "\07\00\00\00\10\00\00\00\00\00\00\00\10\00\00\00\00\00\00\00\10\00\00\00\00\00\00\00\10\00\00\00\00\00\00\00\10\00\00\00\00\00\00\00\10\00\00\00\03\00\00\00\10\00\00\00\00\00\00\00")
 (table $0 1 funcref)
 ...
 (global $contract/MyContract/main i32 (i32.const 5))
 ...
 (export "main" (global $contract/MyContract/main))
 (export "main#get:_receiver" (func $main#get:_receiver))
 (export "main#set:_receiver" (func $main#set:_receiver))
 (export "main#constructor" (func $dmc-ts-lib/lib/contract/Contract#constructor))
 (export "main#get:receiver" (func $dmc-ts-lib/lib/contract/Contract#get:receiver))
 (export "main#get:action" (func $dmc-ts-lib/lib/contract/Contract#get:action))
 (export "main#setActionName" (func $dmc-ts-lib/lib/contract/Contract#setActionName))
 (export "main#hi" (func $contract/MyContract/main#hi))
 (export "main#show" (func $contract/MyContract/main#show))
 ...
 (func $dmc-ts-lib/lib/contract/Contract#constructor (; 27 ;) (type $FUNCSIG$iid) (param $0 i32) (param $1 f64) (result i32)
  local.get $0
  i32.eqz
  if
   i32.const 12
 ...
 (func $dmc-ts-lib/lib/contract/Contract#get:receiver (; 28 ;) (type $FUNCSIG$di) (param $0 i32) (result f64)
  local.get $0
  f64.load
 )
 (func $dmc-ts-lib/lib/contract/Contract#get:action (; 29 ;) (type $FUNCSIG$ii) (param $0 i32) (result i32)
  local.get $0
  i32.load offset=8
  call $~lib/rt/pure/__retain
 )
 (func $dmc-ts-lib/lib/contract/NameEx#constructor (; 30 ;) (type $FUNCSIG$iidd) (param $0 i32) (param $1 f64) (param $2 f64) (result i32)
  local.get $0
  i32.eqz
  if
   i32.const 16
 ...
 (func $dmc-ts-lib/lib/contract/Contract#setActionName (; 31 ;) (type $FUNCSIG$vidd) (param $0 i32) (param $1 f64) (param $2 f64)
  (local $3 i32)
  (local $4 i32)
  local.get $0
  local.tee $3
  ...
  local.get $1
  local.get $2
  call $dmc-ts-lib/lib/contract/NameEx#constructor
  local.set $4
  local.get $3
  i32.load offset=8
 ...
 (func $contract/MyContract/main#hi (; 32 ;) (type $FUNCSIG$didd) (param $0 i32) (param $1 f64) (param $2 f64) (result f64)
  local.get $1
  local.get $2
  f64.add
 )
 (func $contract/lib/Test#constructor (; 33 ;) (type $FUNCSIG$iii) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  local.get $1
  call $~lib/rt/pure/__retain
 ...
 (func $contract/MyContract/main#show (; 34 ;) (type $FUNCSIG$ii) (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  i32.const 0
  i32.const 272
  call $contract/lib/Test#constructor
  local.set $1
  local.get $1
  i32.load
  call $~lib/rt/pure/__retain
   ...
   block $switch$1$case$5
    block $switch$1$case$4
     block $switch$1$case$2
      ...
      i32.sub
      i32.load
      br_table $switch$1$case$2 $switch$1$case$2 $switch$1$case$4 $switch$1$case$5 $switch$1$case$2 $switch$1$case$5 $switch$1$case$4 $switch$1$default
     end
     return
    end
    local.get $0
 ...
 (func $main#get:_receiver (; 38 ;) (type $FUNCSIG$di) (param $0 i32) (result f64)
  local.get $0
  f64.load
 )
 (func $main#set:_receiver (; 39 ;) (type $FUNCSIG$vid) (param $0 i32) (param $1 f64)
  local.get $0
  local.get $1
  f64.store
 )
